...
export default function Navvbar(props) {
  ...
  return (
    <nav className={`navbar navbar-expand-lg bg-${darkMode ? 'dark' : 'light'} navbar-${darkMode ? 'dark' : 'light'}`}>
      <div className="container-fluid">
        ...
        <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Toggle_DarkMode</label>
        </div>
        </div>
      </div>
    </nav>
